...
export const metadata: Metadata = { title: "The menu", description: "Explore Angel’s Indian dishes, from tandoori chicken to dum biryani and vegetarian favorites in Jackson Heights.", alternates: { canonical: "/menu" } };
