...
export function Reservation() {
  return <section className="reservation-band" data-theme="apricot"><div className="container-shell" data-reveal><p className="type-eyebrow">There’s a place for you here</p><span className="apricot-rule reservation-rule" data-reveal="line" aria-hidden="true" /><h2>Come hungry.<br /><em>Leave happy.</em></h2><a className="button button-primary" href={restaurant.resy}>Reserve a table <span aria-hidden="true">↗</span></a><p className="type-caption">Tuesday–Sunday · 12 PM–10 PM</p></div><span className="reservation-flower" aria-hidden="true">✳</span></section>;
}
