...
export default function Home() {
  return (
    <main id="main-content" tabIndex={-1}>
      ...
      <section className="recognition"><div className="container-shell recognition-inner"><div className="michelin-mark" data-reveal><span>MICHELIN</span><strong>Bib<br />Gourmand</strong><small>NEW YORK</small></div><div className="recognition-copy" data-reveal><p className="type-eyebrow">Recognized in New York &amp; beyond</p><h2>Cooking with soul.<br />Celebrated with distinction.</h2><p>Honored with the Michelin Bib Gourmand, and featured by leading voices in food and culture.</p></div><div className="recognition-press" aria-label="Press recognition" data-reveal data-stagger-children><span>The New Yorker</span><span>Eater New York</span><span>Condé Nast Traveller</span><span>Resy</span></div></div></section>
